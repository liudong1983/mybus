...
#define DEFAULT_MYSQL_HOME "/usr/local/mysql-5.5.12"
#define SHAREDIR "/usr/local/mysql-5.5.12/share"
#define DEFAULT_BASEDIR "/usr/local/mysql-5.5.12"
#define MYSQL_DATADIR "/usr/local/mysql-5.5.12/data"
#define DEFAULT_CHARSET_HOME "/usr/local/mysql-5.5.12"
#define PLUGINDIR "/usr/local/mysql-5.5.12/lib/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/mysql-5.5.12/etc"
